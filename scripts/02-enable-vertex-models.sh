...
# =============================================================================
# This script enables the required APIs and Model Garden access for Gemini Workbench.
#
# Prerequisites:
...
SA_NAME="gemini-workbench-vertex"
KEY_PATH="$HOME/.gemini-workbench/vertex-key.json"
...
# List of Vertex AI Model Garden publisher models used by Gemini Workbench
...
echo "  2. Launch Gemini Workbench and select 'Vertex AI' endpoint"
echo ""
echo "Console links:"
