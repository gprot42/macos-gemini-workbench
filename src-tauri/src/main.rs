...
pub struct AppSettings {
    ...
    #[serde(rename = "selectedModel", default, skip_serializing_if = "Option::is_none")]
...
async fn veo_generate_video(
    ...
    api::veo_generate_video(api_key, project_id, prompt, aspect_ratio, model, duration_seconds).await
}
            ...
            .args([
                ...
                r#"tell application "Terminal"
                    ...
                    if (count of windows) = 0 then
                        do script "echo 'Authenticating with Google Cloud...' && gcloud auth login && echo '' && echo 'Authentication complete! You can close this window and return to Gemini Workbench.'"
                    else
                        do script "echo 'Authenticating with Google Cloud...' && gcloud auth login && echo '' && echo 'Authentication complete! You can close this window and return to Gemini Workbench.'" in front window
                    end if
                end tell"#,
            ])
            .output()
    ...
    tauri::Builder::default()
        ...
        .menu(|handle| {
            ...
            let app_menu = Submenu::with_items(
                ...
                true,
                &[
                    &PredefinedMenuItem::about(handle, Some("About Gemini Workbench"), None)?,
